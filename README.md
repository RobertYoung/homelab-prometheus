...
Ansible project for deploying [Prometheus](https://prometheus.io/) via Docker Compose on a single host.

**Target host:** `prometheus.local.iamrobertyoung.co.uk`
...
├── inventories/
│   ├── hosts.yml               # Inventory with prometheus group
│   └── group_vars/             # Group variables
├── host_vars/                  # Host-specific variables
├── roles/
│   └── prometheus/             # Custom Prometheus role
...
| `prometheus` | Custom | Prometheus deployment |
